...
//                 <Sidebar />
//                 <div
//                     className="sm:ml-16 xl:ml-[350px] max-w-2xl flex-grow border-gray-700 border-x">
//                     <div
//                         className="flex space-x-2 px-3 py-2 text-lg sm:text-xl font-bold border-b border-gray-700 sticky top-0 z-50"
//                     >
...
//                             {/* <img className="w-11 h-11 rounded-full object-cover" src={tweetData.photoUrl} /> */}
//                             <img
